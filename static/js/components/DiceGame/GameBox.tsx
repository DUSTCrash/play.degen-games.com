...
function GameBox(props: Props) {
  ...
  const joinGame = async () => {
    ...
    try {
      ...
      await axios.post("/api/game-dice/join", {
        gameId: game._id,
        move: randomNumber,
      });
  ...
  const cancelGame = async () => {
    ...
    try {
      await axios.post("/api/game-dice/cancel", {
        gameId: game._id,
      });
            ...
            <div className="playerWrapper">
              {game.status === "revealed" ? (
                ...
                >
                  <Svg
                    className="move flip"
                    src={`./img/dice${game.creatorMove}.svg`}
                  />
                ...
                <div className="player">
                  <div className="">
                    <Svg
                      ...
                      className="move animate__animated animate__bounce scale-up-085"
                ...
                <div className="player">
                  <Svg className="move scale-up-085" src="./img/dice-question.svg" />
                  <Link to={`/u/${game.creator.publicKey}`} className="address">
                    {displayName(game.creator)}
                  </Link>
                </div>
            ...
            <div className="playerWrapper">
              {!game.opponent ? (
                ...
                >
                  <Svg
                    className="move"
                    src={`./img/dice${game.opponentMove}.svg`}
                  />
                  <Link
